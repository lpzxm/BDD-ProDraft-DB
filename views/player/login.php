...
<div class="bg-white rounded-lg shadow-md flex w-3/4 max-w-2xl">
    <div class="p-10 w-1/2">
        ...
        <div class="mb-4">
            <input type="email" id="email" class="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-gray-700" placeholder="Enter email or user name">
        </div>
        <div class="mb-6 relative">
            <input type="password" id="password" class="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-gray-700" placeholder="Password">
        ...
        <button type="submit" id="loginBtn" class="w-full bg-indigo-500 text-white py-3 rounded-md hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-offset-2">Login</button>
    ...
    <div class="w-1/2 bg-gray-50 rounded-r-lg flex flex-col justify-center items-center p-8">
        ...
        <img src="../../views/img/player/childrens.png" alt="Kids Playing" class="max-w-full h-auto rounded-md">
    </div>
</div>
<script>
    $('#loginBtn').click(function() {
        ...
        $.post("config/modules.php", {
            ...
            if (response === "Entrenador") {
                window.location.href = "http://localhost/?view=dashboard_entrenador";
            } else if (response === "Jugador") {
                window.location.href = "http://localhost/?view=dashboard_jugador";
            } else {
                $.toast({
                    heading: 'Advertencia',
