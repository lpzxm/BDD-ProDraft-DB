...
<head>
    ...
    <title>Mockup Jugador Detalle</title>
        ...
        <aside class="bg-white rounded-lg shadow-md w-64 p-4 mr-4 flex flex-col justify-between">
            ...
            <main class="flex-1 flex flex-col">
                <div class="bg-white rounded-lg shadow-md p-4 mb-4 flex">
                    <div class="w-1/3 p-4">
                        <img src="../img/coach/random.png" alt="Jugador" class="rounded-md mx-auto">
                        <div class="text-center mt-2">
                            <div class="flex justify-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-yellow-500" viewBox="0 0 20 20" fill="currentColor">
                                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.518-1.836a1 1 0 00-1.58 0l-2.518 1.836c-.785.57-1.839-.197-1.539-1.118l1.07-3.292a1 1 0 00-.363-1.118l-2.8-2.034c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.95-.69l1.07-3.292z" />
                                </svg>
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-yellow-500" viewBox="0 0 20 20" fill="currentColor">
                                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.518-1.836a1 1 0 00-1.58 0l-2.518 1.836c-.785.57-1.839-.197-1.539-1.118l1.07-3.292a1 1 0 00-.363-1.118l-2.8-2.034c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.95-.69l1.07-3.292z" />
                                </svg>
                            ...
                            <p class="text-gray-600 text-sm">Delantero</p>
                            <p class="text-gray-600 text-sm">Sub17</p>
                        </div>
                    </div>
                    <div classclass="w-2/3 p-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select id="apellidos" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                        <option>Perez Magno</option>
                                        <option>Otro Apellido</option>
                                    </select>
                        ...
                        <div class="flex justify-end mt-4">
                            ...
                            <button class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded shadow ml-2">
                                Guardar
                            </button>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-4 mb-4 flex justify-around">
                    ...
                    <div class="text-center">
                        <h3 class="font-semibold text-lg mb-2">Rubricas</h3>
                        <button class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                            Rubrica Entrenamiento n1
                        </button>
                    </div>
                    <div class="text-center">
                        <h3 class="font-semibold text-lg mb-2">Asistencia</h3>
                        <div class="bg-indigo-600 text-white rounded-md p-4">
                            14 DE MARZO - PRESENTE
                        </div>
                    </div>
                </div>
